...
- **Command:** `npx -y shannon-code@<tag> --version` must return the correct
...
- **Setup:**
  - [ ] Uninstall any existing global version: `npm uninstall -g shannon-code`
  - [ ] Clear npx cache (optional but recommended): `npm cache clean --force`
  - [ ] Install the preview version: `npm install -g shannon-code@preview`
