...
If you installed the CLI globally (e.g., `npm install -g shannon-code`), use the
`npm uninstall` command with the `-g` flag to remove it.

```bash
npm uninstall -g shannon-code
```
