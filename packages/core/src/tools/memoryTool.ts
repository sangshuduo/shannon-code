...
export const DEFAULT_CONTEXT_FILENAME = 'SHANNON.md';
export const MEMORY_SECTION_HEADER = '## Shannon Added Memories';

// This variable will hold the currently configured filename for SHANNON.md context files.
