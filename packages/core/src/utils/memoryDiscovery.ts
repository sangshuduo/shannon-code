...
/**
 * Traverses upward from startDir to stopDir, finding all SHANNON.md variants.
 *
...
/**
 * Loads hierarchical SHANNON.md files and concatenates their content.
...
export async function loadServerHierarchicalMemory(
  ...
  if (filePaths.length === 0) {
    if (debugMode)
      logger.debug('No SHANNON.md files found in hierarchy of the workspace.');
