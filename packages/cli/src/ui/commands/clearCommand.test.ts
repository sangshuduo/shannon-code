...
vi.mock('@sangshuduo/shannon-core', async () => {
  const actual = await vi.importActual('@sangshuduo/shannon-core');
  return {
    ...actual,
    uiTelemetryService: {
...
import type { GeminiClient } from '@sangshuduo/shannon-core';
import { uiTelemetryService } from '@sangshuduo/shannon-core';
