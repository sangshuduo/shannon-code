...
export const INFORMATIVE_TIPS = [
  ...
  'Choose a specific model for conversations (/settings)...',
  ...
  'Show Shannon CLI status in the terminal window title (/settings)...',
  ...
  'Submit your prompt to Shannon with Enter...',
  ...
  'Create a project-specific SHANNON.md file with /init...',
  ...
  'Reload instructional context from SHANNON.md files with /memory refresh...',
  'List the paths of the SHANNON.md files in use with /memory list...',
  'Choose your model with /model...',
