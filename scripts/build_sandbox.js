...
console.log('packing shannon-code ...');
const cliPackageDir = join('packages', 'cli');
rmSync(join(cliPackageDir, 'dist', 'google-gemini-cli-*.tgz'), { force: true });
execSync(`npm pack -w shannon-code --pack-destination ./packages/cli/dist`, {
  stdio: 'ignore',
});

console.log('packing shannon-core ...');
const corePackageDir = join('packages', 'core');
rmSync(join(corePackageDir, 'dist', 'google-gemini-cli-core-*.tgz'), {
  force: true,
});
execSync(`npm pack -w shannon-core --pack-destination ./packages/core/dist`, {
  stdio: 'ignore',
});
