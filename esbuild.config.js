...
const cliConfig = {
  ...
  outfile: 'packages/cli/bundle/shannon.js',
  define: {
...
Promise.allSettled([
  ...
  if (cliResult.status === 'rejected') {
    console.error('shannon.js build failed:', cliResult.reason);
    process.exit(1);
  }
  // error in a2a-server bundling will not stop shannon.js bundling process
